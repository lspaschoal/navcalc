...
@WebServlet("/servletAerodromosNome") // mapeamento do servlet
public class ServletAerodromosNome extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<Aerodromo> lista = ma.listaAerodromos("nome");
