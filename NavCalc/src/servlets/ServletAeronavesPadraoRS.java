...
@WebServlet("/servletAeronavesPadraoRS") // mapeamento do servlet
public class ServletAeronavesPadraoRS extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<Aeronave> lista = ma.listaAeronaves("razaoSubida");
