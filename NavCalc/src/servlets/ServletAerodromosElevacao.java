...
@WebServlet("/servletAerodromosElevacao") // mapeamento do servlet
public class ServletAerodromosElevacao extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<Aerodromo> lista = ma.listaAerodromos("elevacao");
