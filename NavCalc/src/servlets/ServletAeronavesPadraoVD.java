...
@WebServlet("/servletAeronavesPadraoVD") // mapeamento do servlet
public class ServletAeronavesPadraoVD extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<Aeronave> lista = ma.listaAeronaves("velocidadeDescida");
