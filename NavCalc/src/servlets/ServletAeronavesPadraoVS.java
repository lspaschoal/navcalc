...
@WebServlet("/servletAeronavesPadraoVS") // mapeamento do servlet
public class ServletAeronavesPadraoVS extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<Aeronave> lista = ma.listaAeronaves("velocidadeSubida");
