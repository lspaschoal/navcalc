...
@WebServlet("/servletAeronavesPadraoRD") // mapeamento do servlet
public class ServletAeronavesPadraoRD extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<Aeronave> lista = ma.listaAeronaves("razaoDescida");
