...
@WebServlet("/servletAeronavesPadraoConsumo") // mapeamento do servlet
public class ServletAeronavesPadraoConsumo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<Aeronave> lista = ma.listaAeronaves("consumo");
