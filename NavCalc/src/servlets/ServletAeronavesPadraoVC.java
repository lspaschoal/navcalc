...
@WebServlet("/servletAeronavesPadraoVC") // mapeamento do servlet
public class ServletAeronavesPadraoVC extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ArrayList<Aeronave> lista = ma.listaAeronaves("velocidadeCruzeiro");
